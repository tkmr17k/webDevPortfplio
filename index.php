...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
        ...
        <div class="item active">
          ...
          <div class="header-text hidden-xs">
            <div class="col-md-12 text-center">
              <h2><span>DENTAL CLINIC</span></h2>
              <br>
              <h3><span>We aim at the health beauty of the face and mouth.</span></h3>
              <br>
              <div class="">
  ...
  <section id="about" class="home-section color-dark bg-white">
        ...
        <div class="col-lg-8 col-lg-offset-2">
          <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
            <div class="section-heading text-center">
              ...
              <p>In the old days, the place to cure teeth. The place to cure mind and body is dentistry now.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <img src="img/content1.jpg" alt="" class="img-responsive" />
        ...
        <div class="col-md-6">
          <p>In the old days, dentists were among the doctors who wanted to go the least.That's where the teeth hurt and things go badly and then reluctantly go
            I did not want to go if I could.It is a story of the period when it was thought that dentistry was a place to cure only in the mouth.</p>
          <p>Now, the relationship between teeth and mouth, whole body and spirit has been proven one after another in the latest research.The purpose of the dental visit is to prevent and treat cancer and diseases, to treat beauty, to promote health, to prevent dementia, to improve academic achievement
              More and more people are being consulted at dentists for the purpose of being involved in the mind and body in general, such as the improvement of athletes' abilities.</p>
          <p>The times are changing steadily..</p>
        </div>
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="wow fadeInLeft" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-5x"><i class="fas fa-teeth-open"></i></span>
                </div>
                <div class="service-desc">
                  <h5>Orthodontic</h5>
                  <p>
                  In order to improve various indefinite complaints etc. of the whole body promotion. I will walk with the patient.
                  </p>
          ...
          <div class="col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-5x"><i class="fas fa-tooth"></i></span>
                </div>
                <div class="service-desc">
                  <h5>Maintenance</h5>
                  <p>
                    By performing regular tooth maintenance, you can keep your teeth healthy and healthy.
                  </p>
                  <br>
                  <a href="#" class="btn btn-skin">Learn more</a>
                </div>
          ...
          <div class="col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-5x"><i class="fas fa-heart"></i></span>
                </div>
                <div class="service-desc">
                  <h5>Health</h5>
                  <p>
                    Mouth is the entrance to health. Let's aim at the health condition of our teeth and body.
                  </p>
                  <br>
                  <a href="#" class="btn btn-skin">Learn more</a>
                </div>
          ...
          <div class="col-md-3">
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="service-box">
                <div class="service-icon">
                  <span class="fa fa-5x"><i class="far fa-smile"></i></span>
                </div>
                <div class="service-desc">
                  <h5>Whitening</h5>
                  <p>
                    The first impression changes when the teeth are clean. Our hospital offers two types of whitening.
                  </p>
                  <a href="#" class="btn btn-skin">Learn more</a>
                </div>
              </div>
  ...
  <!-- Section: works -->
  <section id="blog" class="home-section color-dark text-center bg-white">
    <div class="container marginbot-50">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
